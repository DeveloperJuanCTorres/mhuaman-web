...
<div class="container-xxl px-4 px-lg-5" style="padding-top: 120px;">
    <!-- Page Header -->
    <div class="mb-5">
        <h2 class="headline-lg text-dark-blue mb-4 ps-4 border-start border-4 border-secondary">Libro de Reclamaciones</h2>
                ...
                <div class="header-text">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 my-4 text-center">
                            <button class="btn btn-inscribirme py-3 EnviarReclamo">Enviar reclamo</button>
                        </div>
                    </div>
                </div>                
            </div>
